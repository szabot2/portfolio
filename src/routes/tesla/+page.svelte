<main class="font-serif">
	...
	<div class="grid grid-cols-2 w-3/6 mx-auto bg-neutral-800 p-6 rounded-3xl gap-8">
		...
		<div>
			<img class="max-h-full max-w-full rounded-2xl" src="tesla3.jpg" alt="" />
		</div>
	</div>
	...
	<div class="w-8/12 grid grid-cols-2 py-4 px-12 rounded-3xl bg-neutral-800 items-center justify-items-center gap-x-10 my-8 mx-auto text-white text-center">
		<div>
			...
			<img class="rounded-3xl my-2" src="kapcsolas.jpg" alt="" />
		</div>

		<div>
			<h2 class="text-center text-2xl font-semibold">Alkatrészek:</h2>

			<img class="rounded-3xl my-2" src="alkatreszek.jpg" alt="" />
		</div>
	</div>
</main>
